...
private static String[][] board;
    ...
    public static String refresh(int [][] boardMat){
        board = toString(boardMat);
        String line = " "+board[0][0]+" | "+board[0][1]+" | "+board[0][2]+" || "+board[0][3]+" | "+board[0][4]+" | "+board[0][5]+" || "+board[0][6]+" | "+board[0][7]+" | "+board[0][8]+" \n"+
                      "---+---+---++---+---+---++---+---+---\n"+
